...
export interface ApiArtisteArtiste extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Reseau: Attribute.Component<'artiste.reseaux-social', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiInfoPratiqueInfoPratique extends Schema.CollectionType {
  collectionName: 'info_pratiques';
  info: {
    singularName: 'info-pratique';
    pluralName: 'info-pratiques';
    displayName: 'Info Pratique';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    > &
      Attribute.Required;
    Titre_Question: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::info-pratique.info-pratique',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::info-pratique.info-pratique': ApiInfoPratiqueInfoPratique;
